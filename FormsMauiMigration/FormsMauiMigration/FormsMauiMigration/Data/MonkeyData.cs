...
namespace FormsMauiMigration.Data
{
    public static class MonkeyData
    {
        ...
        static MonkeyData()
        {
            ...
            {
                Id = new Guid("8fc55d9b-a1f6-4dde-aaf1-82da0c477d1b"),
                Name = "Baboon",
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("d925603f-7648-4816-9cd4-1ec8ca9f16df"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("39b3e43b-edd6-497a-8fc5-32b26606d974"),
                Name = "Blue Monkey",
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("b94c6896-68a4-490a-9926-144c1486a145"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("b9ca85ce-1011-4578-a4f7-a57c3bd96255"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("2c51b9f1-c5ec-4c00-9048-28fc0db853c5"),
                Name = "Howler Monkey",
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("742ae65a-92a6-4733-87ce-0ae34ade0086"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("0dd18d16-6439-479c-81ad-4564f15ca761"),
                Name = "Mandrill",
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("95142982-db87-4b05-ade0-a4b15ac01c26"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("7f063510-d6ac-44ef-80c9-de9e216adee0"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("0481f974-7fd2-4063-bd09-afca30db8174"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("0a14585c-756d-40ea-85b5-90b481f75b57"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("89eb9d68-15d2-4d80-8b59-106c8aacd607"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("e4cd0b32-20cd-4aa6-a242-ed5c3088457f"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("f0bf91e9-c2d6-46a2-8760-4a826f7f1c0c"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("5dca196b-ee09-4151-833b-14c9a54fdc93"),
            ...
            Monkeys.Add(new Monkey
            {
                Id = new Guid("1699452e-831f-4021-b2c2-09af686e7b2f"),
                Name = "Gelada",
                Location = "Ethiopia",
